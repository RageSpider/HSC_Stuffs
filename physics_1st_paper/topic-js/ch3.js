...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const savedTab = localStorage.getItem('ch3_active_tab') || 'tab-formulas';
    ...
    const loadEquations = async () => {
        ...
        try {
            ...
            const response = await fetch('../topic-data/ch3/equation.json');
            ...
            data.forEach(eq => {
                ...
                // Wrap EACH equation in block math delimiters ($$) as per update
