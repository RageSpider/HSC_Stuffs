// topic-data/ch3/scripts/mcq-function.js
...
window.loadMCQ = function() {
    ...
    fetch('../topic-data/ch3/mcq.json')
        ...
        .catch(err => { container.innerHTML = '<div style="color:var(--ch-accent); text-align:center; padding: 20px; border: 1px dashed var(--ch-accent); border-radius: 20px 0 20px 0;" class="bn-text">ডেটা লোড করতে সমস্যা হয়েছে!</div>'; });
