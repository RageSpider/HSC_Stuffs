// topic-data/ch1/scripts/cq-function.js
...
window.loadCQ = function() {
    ...
    Promise.all([
        fetch('../topic-data/ch1/cq/ka.json').then(r => r.json()),
        fetch('../topic-data/ch1/cq/kha.json').then(r => r.json()),
        fetch('../topic-data/ch1/cq/ga-gha.json').then(r => r.json())
    ]).then(([ka, kha, gagha]) => {
