...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const savedTab = localStorage.getItem('ch7_active_tab') || 'tab-formulas';
    ...
    const loadEquations = async () => {
        ...
        try {
            ...
            const response = await fetch('../topic-data/ch7/equation.json');
            ...
            data.forEach(eq => {
                ...
                equationsHTML = equationsHTML.slice(0, -7); // remove last <br><br>
