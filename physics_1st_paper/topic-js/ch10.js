...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const savedTab = localStorage.getItem('ch10_active_tab') || 'tab-formulas';
    ...
    const loadEquations = async () => {
        ...
        try {
            const response = await fetch('../topic-data/ch10/equation.json');
            ...
            data.forEach(eq => {
                ...
                // Block Math Update: Wrapping each equation in $$
            ...
            console.error(error);
            container.innerHTML = '<div class="bn-text" style="color:red;">সূত্রাবলি লোড করতে সমস্যা হয়েছে।</div>';
        }
    };
