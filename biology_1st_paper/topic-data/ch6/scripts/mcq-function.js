// topic-data/ch6/scripts/mcq-function.js
...
window.loadMCQ = function() {
    ...
    fetch('../topic-data/ch6/mcq.json')
        ...
        .catch(err => { container.innerHTML = '<div style="color:red; text-align:center;" class="bn-text">ডেটা লোড করতে সমস্যা হয়েছে!</div>'; });
    ...
    function renderMCQs() {
        ...
        if (filtered.length === 0) {
            container.innerHTML = '<div style="text-align:center; color:var(--text-muted); padding: 30px;" class="bn-text">কোনো প্রশ্ন পাওয়া যায়নি।</div>';
            return;
        }
